...
description: Tools designed to track metrics, monitor performance, gather insights, and analyze data across products, users, systems, and financial sources.
parent: Node Types
nav_order: 8
---
...
Analytics Nodes allow workflows to collect data, analyze patterns, monitor performance, measure user behavior, track financial indicators, and feed information into dashboards and reporting systems.  
These nodes connect automation to your analytical ecosystem — enabling insights-driven workflows that react to real metrics instead of static assumptions.

Whether you're tracking product usage, monitoring operational health, measuring revenue signals, or analyzing customer segments, Analytics Nodes provide the bridge between raw data and actionable outcomes.
...
- Triggering alerts or actions based on monitoring data  
- Updating dashboards after each workflow cycle  
- Enriching customer or lead data with external intelligence  
- Adding behavioral insights to user journeys  
- Pulling market prices or KPIs for decision-making  
- Collecting performance data from fleet or operations  
- Feeding BI tools with fresh values  
- Running data-driven routing inside flows  

In short:  
**If a workflow needs to “know what’s happening,” Analytics Nodes make it possible.**
...
| Benefit | Description |
|--------|-------------|
| **Data-aware workflows** | Your automations respond to real metrics, not assumptions. |
| **Centralized insight collection** | Pull analytics from many platforms into one place. |
| **Better monitoring & alerting** | Detect issues early across systems, users, or performance. |
| **AI-supported segmentation** | Understand user behavior at a deeper level. |
| **Smarter dashboards** | Keep BI platforms up to date automatically. |
